...
var T = (e, t, n) => (sl(e, t, "read from private field"),
n ? n.call(e) : t.get(e))
  , Z = (e, t, n) => t.has(e) ? pc("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n)
  , U = (e, t, n, r) => (sl(e, t, "write to private field"),
r ? r.call(e, n) : t.set(e, n),
n)
  , Pe = (e, t, n) => (sl(e, t, "access private method"),
n);
var fi = (e, t, n, r) => ({
    set _(o) {
        U(e, t, o, n)
...
var gc = /\/+/g;
function ll(e, t) {
    return typeof e == "object" && e !== null && e.key != null ? _g("" + e.key) : t.toString(36)
}
function ji(e, t, n, r, o) {
    ...
    if (s)
        ...
        ji(o, t, n, "", function(u) {
            return u
        })) : o != null && (Za(o) && (o = Og(o, n + (!o.key || s && s.key === o.key ? "" : ("" + o.key).replace(gc, "$&/") + "/") + e)),
        t.push(o)),
        1;
    if (s = 0,
    r = r === "" ? "." : r + ":",
...
var Mg = x
  ...
  , Fg = Mg.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner
  , zg = {
    key: !0,
    ref: !0,
    __self: !0,
...
function bf(e, t, n) {
    ...
    for (r in t)
        Dg.call(t, r) && !zg.hasOwnProperty(r) && (o[r] = t[r]);
    if (e && e.defaultProps)
...
(function(e) {
    ...
    function C(b, N) {
        ...
        try {
            for (g(N),
            f = n(a); f !== null && (!(f.expirationTime > N) || b && !z()); ) {
                var W = f.callback;
    ...
    e.unstable_scheduleCallback = function(b, N, j) {
        ...
        j > W ? (b.sortIndex = j,
        t(u, b),
        n(a) === null && b === n(u) && (v ? (m(R),
        R = -1) : v = !0,
        V(S, j - W))) : (b.sortIndex = F,
        t(a, b),
        w || d || (w = !0,
        $(C))),
        b
...
var Wt = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , yc = {};
function Vg(e) {
    return $l.call(yc, e) ? !0 : $l.call(vc, e) ? !1 : Ug.test(e) ? yc[e] = !0 : (vc[e] = !0,
    !1)
}
function Wg(e, t, n, r) {
    if (n !== null && n.type === 0)
...
function Hg(e, t, n, r) {
    if (t === null || typeof t > "u" || Wg(e, t, n, r))
        return !0;
    if (r)
        return !1;
    if (n !== null)
...
function tu(e, t, n, r) {
    ...
    (o !== null ? o.type !== 0 : r || !(2 < t.length) || t[0] !== "o" && t[0] !== "O" || t[1] !== "n" && t[1] !== "N") && (Hg(t, n, o, r) && (n = null),
...
var Xt = Bg.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
...
function Ql(e, t) {
    ...
    t.hasOwnProperty("value") ? Kl(e, t.type, n) : t.hasOwnProperty("defaultValue") && Kl(e, t.type, Nn(t.defaultValue)),
...
var np, au, rp, op, ip, ra = !1, wi = [], xn = null, Sn = null, En = null, jo = new Map, Io = new Map, cn = [], pv = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function bc(e, t) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function ap() {
    if (Fi)
        return Fi;
    var e, t = cu, n = t.length, r, o = "value"in vn ? vn.value : vn.textContent, i = o.length;
...
function Ze(e) {
    function t(n, r, o, i, s) {
        ...
        for (var l in e)
            ...
            this[l] = n ? n(i) : i[l]);
        return this.isDefaultPrevented = (i.defaultPrevented != null ? i.defaultPrevented : i.returnValue === !1) ? xi : Rc,
...
var eo = {
    ...
    movementX: function(e) {
        return "movementX"in e ? e.movementX : (e !== fo && (fo && e.type === "mousemove" ? (pl = e.screenX - fo.screenX,
        hl = e.screenY - fo.screenY) : hl = pl = 0,
        fo = e),
        pl)
    },
...
var Bv = Wt && "TextEvent"in window && !ko
  , up = Wt && (!pu || ko && 8 < ko && 11 >= ko)
  , Lc = " "
  , Mc = !1;
function cp(e, t) {
    switch (e) {
...
function Vv(e, t) {
    if (vr)
        return e === "compositionend" || !pu && cp(e, t) ? (e = ap(),
        Fi = cu = vn = null,
        vr = !1,
        e) : null;
    switch (e) {
...
function fp(e, t, n, r) {
    Vf(r),
    t = rs(t, "onChange"),
    0 < t.length && (n = new du("onChange","change",null,n,r),
    e.push({
        event: n,
        listeners: t
    }))
...
function Kv(e, t, n) {
    ...
    Po = t,
    Fo = n,
    Po.attachEvent("onpropertychange", hp)) : e === "focusout" && Dc()
}
function Yv(e) {
...
function $c(e, t, n) {
    ...
    To && zo(To, r) || (To = r,
    r = rs(ia, "onSelect"),
    0 < r.length && (t = new du("onSelect","select",null,t,n),
    e.push({
        event: t,
        listeners: r
    }),
...
var wr = {
  ...
  , yl = {}
  , vp = {};
Wt && (vp = document.createElement("div").style,
...
var yp = _s("animationend")
  , wp = _s("animationiteration")
  , xp = _s("animationstart")
  , Sp = _s("transitionend")
  , Ep = new Map
...
function $o(e) {
    if (!e[Ei]) {
        ...
        _f.forEach(function(n) {
            n !== "selectionchange" && (ny.has(n) || Sl(n, !1, e),
            Sl(n, !0, e))
        });
        var t = e.nodeType === 9 ? e : e.ownerDocument;
        t === null || t[Ei] || (t[Ei] = !0,
        Sl("selectionchange", !1, t))
    }
}
function kp(e, t, n, r) {
    switch (lp(t)) {
    ...
    Kf(function() {
        ...
        if (!(t & 7)) {
            e: {
                ...
                h && n !== Zl && (w = n.relatedTarget || n.fromElement) && (Un(w) || w[Ht]))
                    break e;
                ...
                d !== w)) {
                    ...
                    h.relatedTarget = g,
                    S = null,
                    Un(c) === u && (v = new v(m,p + "enter",w,n,c),
                    v.target = g,
                    v.relatedTarget = y,
                    S = v),
                    y = S,
            ...
            e: {
                ...
                d === "select" || d === "input" && h.type === "file")
                    ...
                    (d = h.nodeName) && d.toLowerCase() === "input" && (h.type === "checkbox" || h.type === "radio") && (C = Gv);
                if (C && (C = C(e, u))) {
                    fp(f, C, n, c);
                    break e
                }
                k && k(e, h, u),
                e === "focusout" && (k = h._wrapperState) && k.controlled && h.type === "number" && Kl(h, "number", h.value)
            }
            switch (k = u ? xr(u) : window,
            e) {
            case "focusin":
                (jc(k) || k.contentEditable === "true") && (yr = k,
                ia = u,
                To = null);
                break;
            case "focusout":
            ...
            R && (up && n.locale !== "ko" && (vr || R !== "onCompositionStart" ? R === "onCompositionEnd" && vr && (P = ap()) : (vn = c,
            cu = "value"in vn ? vn.value : vn.textContent,
            vr = !0)),
            k = rs(u, R),
            0 < k.length && (R = new _c(R,e,null,n,c),
            f.push({
                event: R,
                listeners: k
            }),
            P ? R.data = P : (P = dp(n),
            P !== null && (R.data = P)))),
            (P = Bv ? Uv(e, n) : Vv(e, n)) && (u = rs(u, "onBeforeInput"),
            0 < u.length && (c = new _c("onBeforeInput","beforeinput",null,n,c),
            f.push({
                event: c,
                listeners: u
            }),
...
var ca = typeof setTimeout == "function" ? setTimeout : void 0
  ...
  , sy = typeof queueMicrotask == "function" ? queueMicrotask : typeof Hc < "u" ? function(e) {
...
function Pp(e, t, n) {
    ...
    for (var o in r)
        if (!(o in t))
            throw Error(O(108, Kg(e) || "Unknown", o));
    return ce({}, n, r)
}
function ss(e) {
    ...
    if (le) {
        ...
        if (t) {
            ...
            if (!Gc(e, t)) {
                ...
                t = Cn(n.nextSibling);
                var r = Ye;
                t && Gc(e, t) ? Np(r, n) : (e.flags = e.flags & -4097 | 2,
                le = !1,
                Ye = e)
            }
        } else {
...
function Op(e) {
    ...
    function l(m, p, g, S) {
        return p === null || p.tag !== 6 ? (p = _l(g, m.mode, S),
        p.return = m,
        p) : (p = o(p, g),
        p.return = m,
        p)
    ...
    function a(m, p, g, S) {
        var C = g.type;
        return C === gr ? c(m, p, g.props.children, S, g.key) : p !== null && (p.elementType === C || typeof C == "object" && C !== null && C.$$typeof === an && qc(C) === p.type) ? (S = o(p, g.props),
        S.ref = po(m, p, g),
        S.return = m,
        S) : (S = Qi(g.type, g.key, g.props, null, m.mode, S),
        S.ref = po(m, p, g),
        S.return = m,
        S)
    }
    function u(m, p, g, S) {
        return p === null || p.tag !== 4 || p.stateNode.containerInfo !== g.containerInfo || p.stateNode.implementation !== g.implementation ? (p = Al(g, m.mode, S),
        p.return = m,
        p) : (p = o(p, g.children || []),
        p.return = m,
        p)
    ...
    function c(m, p, g, S, C) {
        return p === null || p.tag !== 7 ? (p = Zn(g, m.mode, S, C),
        p.return = m,
        p) : (p = o(p, g),
        p.return = m,
        p)
    ...
    function h(m, p, g, S) {
        ...
        if (typeof g == "object" && g !== null) {
            ...
            case an:
                return C = g._init,
                h(m, p, C(g._payload), S)
            }
            if (wo(g) || lo(g))
                return C !== null ? null : c(m, p, g, S, null);
            Pi(m, g)
        }
        return null
    }
                ...
                e: {
                    for (var C = g.key, k = p; k !== null; ) {
                        if (k.key === C) {
                            ...
                            } else if (k.elementType === C || typeof C == "object" && C !== null && C.$$typeof === an && qc(C) === k.type) {
                                n(m, k.sibling),
                                p = o(k, g.props),
                                p.ref = po(m, k, g),
                                p.return = m,
                    ...
                    p.return = m,
                    m = p) : (S = Qi(g.type, g.key, g.props, null, m.mode, S),
                    S.ref = po(m, p, g),
                    S.return = m,
                    m = S)
                }
...
function bu(e, t, n, r, o, i) {
    ...
    t.updateQueue = null,
    t.lanes = 0,
    Bi.current = e === null || e.memoizedState === null ? gy : vy,
    e = n(r, o),
    bo) {
        i = 0;
        do {
...
function Ip(e, t) {
    ...
    ze = !0),
    r = r.queue,
    Ru(zp.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || i || we !== null && we.memoizedState.tag & 1) {
        if (n.flags |= 2048,
        Ko(9, Fp.bind(null, n, r, o, t), void 0, null),
        xe === null)
            throw Error(O(349));
        tr & 30 || Dp(n, t, o)
    }
...
var hs = {
  ...
  , gy = {
    ...
    useImperativeHandle: function(e, t, n) {
        return n = n != null ? n.concat([e]) : null,
        Ui(4194308, 4, Hp.bind(null, t, e), n)
    },
    ...
    useSyncExternalStore: function(e, t, n) {
        ...
        return o.queue = i,
        td(zp.bind(null, r, i, e), [e]),
        r.flags |= 2048,
        Ko(9, Fp.bind(null, r, i, n, t), void 0, null),
        n
    },
    useId: function() {
        var e = Pt()
...
function eh(e, t, n) {
    var r = !1
      , o = Rn
      , i = t.contextType;
    return typeof i == "object" && i !== null ? i = it(i) : (o = Be(t) ? Jn : Oe.current,
    r = t.contextTypes,
...
function va(e, t, n, r) {
    ...
    Eu(e);
    var i = t.contextType;
    typeof i == "object" && i !== null ? o.context = it(i) : (i = Be(t) ? Jn : Oe.current,
    o.context = Hr(e, i)),
    o.state = e.memoizedState,
    i = t.getDerivedStateFromProps,
    typeof i == "function" && (ga(e, t, i, n),
    o.state = e.memoizedState),
...
function ad(e, t, n, r, o) {
    if (e === null) {
        var i = n.type;
        return typeof i == "function" && !Fu(i) && i.defaultProps === void 0 && n.compare === null && n.defaultProps === void 0 ? (t.tag = 15,
        t.type = i,
        rh(e, t, i, r, o)) : (e = Qi(n.type, null, r, t, t.mode, o),
        e.ref = t.ref,
        e.return = t,
        t.child = e)
    }
...
function ud(e, t, n, r, o) {
    ...
    t.stateNode === null)
        ...
        var a = s.context
          , u = n.contextType;
        typeof u == "object" && u !== null ? u = it(u) : (u = Be(n) ? Jn : Oe.current,
        u = Hr(t, u));
        var c = n.getDerivedStateFromProps
          , f = typeof c == "function" || typeof s.getSnapshotBeforeUpdate == "function";
        f || typeof s.UNSAFE_componentWillReceiveProps != "function" && typeof s.componentWillReceiveProps != "function" || (l !== r || a !== u) && rd(t, s, r, u),
        un = !1;
        var h = t.memoizedState;
        s.state = h,
        ds(t, r, s, o),
        a = t.memoizedState,
        l !== r || h !== a || $e.current || un ? (typeof c == "function" && (ga(t, n, c, r),
        a = t.memoizedState),
        (l = un || nd(t, n, l, r, h, a, u)) ? (f || typeof s.UNSAFE_componentWillMount != "function" && typeof s.componentWillMount != "function" || (typeof s.componentWillMount == "function" && s.componentWillMount(),
        ...
        h = s.context,
        a = n.contextType,
        typeof a == "object" && a !== null ? a = it(a) : (a = Be(n) ? Jn : Oe.current,
        a = Hr(t, a));
        var d = n.getDerivedStateFromProps;
        (c = typeof d == "function" || typeof s.getSnapshotBeforeUpdate == "function") || typeof s.UNSAFE_componentWillReceiveProps != "function" && typeof s.componentWillReceiveProps != "function" || (l !== f || h !== a) && rd(t, s, r, a),
        un = !1,
        h = t.memoizedState,
        s.state = h,
        ds(t, r, s, o);
        var w = t.memoizedState;
        l !== f || h !== w || $e.current || un ? (typeof d == "function" && (ga(t, n, d, r),
        w = t.memoizedState),
        (u = un || nd(t, n, u, r, h, w, a) || !1) ? (c || typeof s.UNSAFE_componentWillUpdate != "function" && typeof s.componentWillUpdate != "function" || (typeof s.componentWillUpdate == "function" && s.componentWillUpdate(r, w, a),
...
function lh(e, t, n) {
    ...
    if (i) {
        ...
        l !== null ? i = bn(l, i) : (i = Zn(i, s, n, null),
        i.flags |= 2),
        i.return = t,
        r.return = t,
        r.sibling = i,
...
function Cy(e, t, n) {
                ...
                e: {
                    ...
                    for (i in l)
                        if (l.hasOwnProperty(i)) {
                            ...
                            a != null && $f(e, a)) : i === "children" ? typeof a == "string" ? (n !== "textarea" || a !== "") && Lo(e, a) : typeof a == "number" && Lo(e, "" + a) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (Ao.hasOwnProperty(i) ? a != null && i === "onScroll" && oe("scroll", e) : a != null && tu(e, i, a, s))
                        }
                    switch (n) {
                    case "input":
                        mi(e),
    ...
    case 13:
        ...
        t.mode & 1 && (e === null || ae.current & 1 ? ye === 0 && (ye = 3) : Du())),
...
function mh(e, t) {
            ...
            a !== null)
                try {
                    ...
                    for (s = 0; s < a.length; s += 2) {
                        var c = a[s]
                          , f = a[s + 1];
                        c === "style" ? Uf(o, f) : c === "dangerouslySetInnerHTML" ? $f(o, f) : c === "children" ? Lo(o, f) : tu(o, c, f, u)
                    }
                    switch (l) {
                    case "input":
                        Ql(o, i);
    ...
    case 13:
        ...
        !i || o.alternate !== null && o.alternate.memoizedState !== null || (Mu = pe())),
        r & 4 && hd(e);
        break;
    case 22:
            ...
            if (!s) {
                ...
                (Re = a) && !u)
                    for (I = o; I !== null; )
                        s = I,
                        a = s.child,
                        s.tag === 22 && s.memoizedState !== null ? vd(o) : a !== null ? (a.return = s,
                        I = a) : vd(o);
                for (; i !== null; )
                    I = i,
                    gh(i),
...
function Tn(e) {
    return e.mode & 1 ? q & 2 && Ee !== 0 ? Ee & -Ee : dy.transition !== null ? (Hi === 0 && (Hi = ep()),
    Hi) : (e = ee,
    e !== 0 || (e = window.event,
...
function Ue(e, t) {
    ...
    e.callbackPriority !== t) {
        if (n != null && Tc(n),
        t === 1)
            e.tag === 0 ? cy(yd.bind(null, e)) : Tp(yd.bind(null, e)),
            sy(function() {
                !(q & 6) && In()
            }),
            n = null;
        ...
        if (t === 6)
            ...
            case 3:
                ...
                10 < t)) {
                    ...
                    e.timeoutHandle = ca(Bn.bind(null, e, Fe, Ft), t);
                    break
                }
                Bn(e, Fe, Ft);
                break;
            case 4:
                ...
                10 < r) {
                    e.timeoutHandle = ca(Bn.bind(null, e, Fe, Ft), r);
                    break
                }
                Bn(e, Fe, Ft);
                break;
...
function Ly(e, t, n) {
    ...
    xe === e && (Ee & n) === n && (ye === 4 || ye === 3 && (Ee & 130023424) === Ee && 500 > pe() - Mu ? qn(e, 0) : Lu |= n),
    Ue(e, t)
}
function Eh(e, t) {
    t === 0 && (e.mode & 1 ? (t = yi,
...
Ch = function(e, t, n) {
    if (e !== null)
        ...
        ze = !1,
        le && t.flags & 1048576 && bp(t, as, t.index);
    switch (t.lanes = 0,
    t.tag) {
    case 2:
        var r = t.type;
...
$s.prototype.render = Bu.prototype.render = function(e) {
...
;
$s.prototype.unmount = Bu.prototype.unmount = function() {
...
function Go(e) {
    return JSON.stringify(e, (t, n) => La(n) ? Object.keys(n).sort().reduce( (r, o) => (r[o] = n[o],
    r), {}) : n)
}
function Xo(e, t) {
...
function Gy(e, t, n) {
    return typeof n.structuralSharing == "function" ? n.structuralSharing(e, t) : n.structuralSharing !== !1 ? _h(e, t) : t
}
function Xy(e, t, n=0) {
    const r = [...e, t];
...
var Hn, fn, Ir, lf, Zy = (lf = class extends Vs {
    constructor() {
        super();
        Z(this, Hn);
        Z(this, fn);
...
fn = new WeakMap,
Ir = new WeakMap,
lf), Lh = new Zy, Dr, pn, Fr, af, Jy = (af = class extends Vs {
    constructor() {
        super();
        Z(this, Dr, !0);
        Z(this, pn);
...
function Ih(e) {
    ...
    const i = e0()
      ...
      , u = () => Lh.isFocused() && (e.networkMode === "always" || xs.isOnline()) && e.canRun()
...
var Le = r0(), Qn, uf, Dh = (uf = class {
    ...
    scheduleGc() {
        this.clearGcTimeout(),
        Hy(this.gcTime) && U(this, Qn, setTimeout( () => {
            this.optionalRemove()
        }
        , this.gcTime))
    }
...
,
Qn = new WeakMap,
uf), zr, Kn, et, Yn, Ne, Jo, Gn, ht, Dt, cf, o0 = (cf = class extends Dh {
    constructor(t) {
        super();
        Z(this, ht);
        Z(this, zr);
        ...
        Z(this, Gn);
        U(this, Gn, !1),
        U(this, Jo, t.defaultOptions),
        this.setOptions(t.options),
        this.observers = [],
        U(this, Yn, t.client),
        U(this, et, T(this, Yn).getQueryCache()),
        this.queryKey = t.queryKey,
        this.queryHash = t.queryHash,
        U(this, zr, s0(this.options)),
    ...
    cancel(t) {
        ...
        return (o = T(this, Ne)) == null || o.cancel(t),
    ...
    isStatic() {
        return this.getObserversCount() > 0 ? this.observers.some(t => Aa(t.options.staleTime, this) === "static") : !1
    }
    isStale() {
        return this.getObserversCount() > 0 ? this.observers.some(t => t.getCurrentResult().isStale) : this.state.data === void 0 || this.state.isInvalidated
    }
    isStaleByTime(t=0) {
        return this.state.data === void 0 ? !0 : t === "static" ? !1 : this.state.isInvalidated ? !0 : !Qy(this.state.dataUpdatedAt, t)
    }
    onFocus() {
        var n;
    ...
    removeObserver(t) {
        ...
        this.observers.length || (T(this, Ne) && (T(this, Gn) ? T(this, Ne).cancel({
            revert: !0
    ...
    fetch(t, n) {
        ...
        if (this.state.fetchStatus !== "idle") {
            if (this.state.data !== void 0 && (n != null && n.cancelRefetch))
                ...
                return T(this, Ne).continueRetry(),
                T(this, Ne).promise
        }
        ...
        const a = h => {
            var d, w, v, y;
            Ll(h) && h.silent || Pe(this, ht, Dt).call(this, {
                type: "error",
                error: h
            }),
            Ll(h) || ((w = (d = T(this, et).config).onError) == null || w.call(d, h, this),
            (y = (v = T(this, et).config).onSettled) == null || y.call(v, this.state.data, h, this)),
            this.scheduleGc()
        }
        ;
        return U(this, Ne, Ih({
            ...
            onSuccess: h => {
                ...
                (y = (v = T(this, et).config).onSettled) == null || y.call(v, h, this.state.error, this),
                this.scheduleGc()
            }
            ,
            onError: a,
...
Dt = function(t) {
    const n = r => {
        ...
        case "error":
            const o = t.error;
            return Ll(o) && o.revert && T(this, Kn) ? {
                ...T(this, Kn),
                fetchStatus: "idle"
            } : {
                ...r,
...
var Tt, df, l0 = (df = class extends Vs {
    constructor(t={}) {
        super();
        Z(this, Tt);
        this.config = t,
...
,
Tt = new WeakMap,
df), bt, _e, Xn, Nt, ln, ff, a0 = (ff = class extends Dh {
    constructor(t) {
        super();
        Z(this, Nt);
        Z(this, bt);
    ...
    removeObserver(t) {
        U(this, bt, T(this, bt).filter(n => n !== t)),
        this.scheduleGc(),
        T(this, _e).notify({
            type: "observerRemoved",
            mutation: this,
    ...
    async execute(t) {
        ...
        try {
            ...
            try {
                ...
                await ((k = (C = T(this, _e).config).onSettled) == null ? void 0 : k.call(C, void 0, L, this.state.variables, this.state.context, this)),
...
var $t, mt, ei, pf, c0 = (pf = class extends Vs {
    constructor(t={}) {
        super();
        Z(this, $t);
        Z(this, mt);
...
var de, hn, mn, $r, Br, gn, Ur, Vr, hf, f0 = (hf = class {
    constructor(e={}) {
        Z(this, de);
        Z(this, hn);
        Z(this, mn);
        ...
        Z(this, Ur);
        Z(this, Vr);
        U(this, de, e.queryCache || new l0),
        U(this, hn, e.mutationCache || new c0),
    ...
    mount() {
        ...
        T(this, gn) === 1 && (U(this, Ur, Lh.subscribe(async e => {
            e && (await this.resumePausedMutations(),
            T(this, de).onFocus())
        }
        )),
        U(this, Vr, xs.subscribe(async e => {
            e && (await this.resumePausedMutations(),
            T(this, de).onOnline())
        }
        )))
    ...
    unmount() {
        ...
        T(this, gn) === 0 && ((e = T(this, Ur)) == null || e.call(this),
        U(this, Ur, void 0),
    ...
    ensureQueryData(e) {
        const t = this.defaultQueryOptions(e)
          ...
          , r = n.state.data;
        return r === void 0 ? this.fetchQuery(e) : (e.revalidateIfStale && n.isStaleByTime(Aa(t.staleTime, n)) && this.prefetchQuery(t),
        Promise.resolve(r))
    }
    getQueriesData(e) {
    ...
    fetchQuery(e) {
        ...
        return n.isStaleByTime(Aa(t.staleTime, n)) ? n.fetch(t) : Promise.resolve(n.state.data)
    }
    prefetchQuery(e) {
        return this.fetchQuery(e).then(pt).catch(pt)
    }
    fetchInfiniteQuery(e) {
        return e.behavior = bd(e.pages),
        this.fetchQuery(e)
    }
    ...
    resumePausedMutations() {
        return xs.isOnline() ? T(this, hn).resumePausedMutations() : Promise.resolve()
    }
    getQueryCache() {
        return T(this, de)
    }
    ...
    defaultQueryOptions(e) {
        ...
        return t.queryHash || (t.queryHash = Vu(t.queryKey, t)),
...
Ur = new WeakMap,
Vr = new WeakMap,
hf), p0 = x.createContext(void 0), h0 = ({client: e, children: t}) => (x.useEffect( () => (e.mount(),
() => {
    e.unmount()
}
), [e]),
...
function v0(e, t, n, r) {
    ...
    let v = {
        ...
        listen(y) {
            ...
            return o.addEventListener(Rd, f),
            a = y,
            () => {
                o.removeEventListener(Rd, f),
                a = null
            }
        },
        createHref(y) {
...
function b0(e, t) {
    let n = e.split("/")
      , r = n.length;
    return n.some(Ad) && (r += T0),
    t && (r += C0),
    n.filter(o => !Ad(o)).reduce( (o, i) => o + (S0.test(i) ? E0 : i === "" ? k0 : P0), r)
}
function N0(e, t) {
...
function R0(e, t, n) {
    ...
    for (let l = 0; l < r.length; ++l) {
        ...
        s.push({
            ...
            pathnameBase: A0(Lr([i, f.pathnameBase])),
            route: h
        }),
...
function F0(e, t, n, r) {
    Hu() || Ve(!1);
    let {navigator: o} = x.useContext(Wh)
    ...
    let w = y0(e, {
      ...
      , v = V0(w && w.map(y => Object.assign({}, y, {
    ...
    return t && v ? x.createElement(Qs.Provider, {
        value: {
            location: Es({
                pathname: "/",
                search: "",
...
class B0 extends x.Component {
    ...
    render() {
        return this.state.error !== void 0 ? x.createElement(Ks.Provider, {
            value: this.props.routeContext
        }, x.createElement(Hh.Provider, {
...
function V0(e, t, n, r) {
    ...
    return s.reduceRight( (c, f, h) => {
        ...
        ;
        return n && (f.route.ErrorBoundary || f.route.errorElement || h === 0) ? x.createElement(B0, {
            location: n.location,
...
function K0() {
    ...
    let t = x.useContext(Hh)
      , n = W0(ja.UseRouteError)
      , r = Q0(ja.UseRouteError);
...
function G0(e) {
    ...
    , [a, c, f, h, d, w, o]);
    return v == null ? null : x.createElement(Wh.Provider, {
        value: u
...
function Da(e, t) {
    ...
    return x.Children.forEach(e, (r, o) => {
        ...
        r.props.children && (s.children = Da(r.props.children, i)),
        n.push(s)
    }
    ),
    n
    ...
    let u = i === "system"
      ...
      , h = (w, v=!1, y=!0) => {
        let m = s ? s[w] : w
          , p = v ? w + "|| ''" : `'${m}'`
          , g = "";
        return o && y && !v && Dd.includes(w) && (g += `d.style.colorScheme = '${w}';`),
        n === "class" ? v || m ? g += `c.add(${p})` : g += "null" : m && (g += `d[s](n,${p})`),
        g
    }
      , d = e ? `!function(){${c}${h(e)}}()` : r ? `!function(){try{${c}var e=localStorage.getItem('${t}');if('system'===e||(!e&&${u})){var t='${ew}',m=window.matchMedia(t);if(m.media!==t||m.matches){${h("dark")}}else{${h("light")}}}else if(e){${s ? `var x=${JSON.stringify(s)};` : ""}${h(s ? "x[e]" : "e", !0)}}${u ? "" : "else{" + h(i, !1, !1) + "}"}${f}}catch(e){}}()` : `!function(){try{${c}var e=localStorage.getItem('${t}');if(e){${s ? `var x=${JSON.stringify(s)};` : ""}${h(s ? "x[e]" : "e", !0)}}else{${h(i, !1, !1)};}${f}}catch(t){}}();`;
...
var ow = e => {
  ...
  , iw = Array(12).fill(0)
  , sw = ({visible: e, className: t}) => _.createElement("div", {
    className: ["sonner-loading-wrapper", t].filter(Boolean).join(" "),
    "data-visible": e
}, _.createElement("div", {
    className: "sonner-spinner"
}, iw.map( (n, r) => _.createElement("div", {
    className: "sonner-loading-bar",
    key: `spinner-bar-${r}`
}))))
  , lw = _.createElement("svg", {
...
var Nw = e => {
    ...
    let {invert: h, toast: d, unstyled: w, interacting: v, setHeights: y, visibleToasts: m, heights: p, index: g, toasts: S, expanded: C, removeToast: k, defaultRichColors: P, closeButton: R, style: L, cancelButtonStyle: A, actionButtonStyle: z, className: D="", descriptionClassName: Q="", duration: M, position: G, gap: $, loadingIcon: V, expandByDefault: b, classNames: N, icons: j, closeButtonAriaLabel: W="Close toast", pauseWhenPageIsHidden: F} = e
      , [K,X] = _.useState(null)
      ...
      , di = _.useMemo( () => p.findIndex(B => B.toastId === d.id) || 0, [p, d.id])
      , pg = _.useMemo( () => {
        var B;
        return (B = d.closeButton) != null ? B : R
    }
    , [d.closeButton, R])
      , uc = _.useMemo( () => d.duration || M || Fd, [d.duration, M])
      , ol = _.useRef(0)
      , fr = _.useRef(0)
      , cc = _.useRef(0)
      , pr = _.useRef(null)
      , [hg,mg] = G.split("-")
      , dc = _.useMemo( () => p.reduce( (B, te, se) => se >= di ? B : B + te.height, 0), [p, di])
      , fc = fw()
      , gg = d.invert || h
      , il = Je === "loading";
    fr.current = _.useMemo( () => di * $ + dc, [di, dc]),
    _.useEffect( () => {
        so.current = uc
    }
    , [uc]),
    ...
    _.useEffect( () => {
        ...
        )() : so.current !== 1 / 0 && (ol.current = new Date().getTime(),
        B = setTimeout( () => {
            var te;
    ...
    return _.createElement("li", {
        tabIndex: 0,
        ref: Fn,
        className: dt(D, dg, N == null ? void 0 : N.toast, (t = d == null ? void 0 : d.classNames) == null ? void 0 : t.toast, N == null ? void 0 : N.default, N == null ? void 0 : N[Je], (n = d == null ? void 0 : d.classNames) == null ? void 0 : n[Je]),
        "data-sonner-toast": "",
        ...
        onPointerUp: () => {
            ...
            if (Jt || !dr)
                return;
            pr.current = null;
            let at = Number(((B = Fn.current) == null ? void 0 : B.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0)
              , tn = Number(((te = Fn.current) == null ? void 0 : te.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0)
              , zn = new Date().getTime() - ((se = ac.current) == null ? void 0 : se.getTime())
              , ut = K === "x" ? at : tn
              , nn = Math.abs(ut) / zn;
            if (Math.abs(ut) >= Pw || nn > .11) {
                io(fr.current),
        ...
        onPointerMove: B => {
            ...
            if (!pr.current || !dr || ((te = window.getSelection()) == null ? void 0 : te.toString().length) > 0)
                return;
            let tn = B.clientY - pr.current.y
              , zn = B.clientX - pr.current.x
    ...
    }, pg && !d.jsx ? _.createElement("button", {
        "aria-label": W,
        "data-disabled": il,
        "data-close-button": !0,
        onClick: il || !dr ? () => {}
    ...
    }, (i = j == null ? void 0 : j.close) != null ? i : dw) : null, d.jsx || x.isValidElement(d.title) ? d.jsx ? d.jsx : typeof d.title == "function" ? d.title() : d.title : _.createElement(_.Fragment, null, Je || d.icon || d.promise ? _.createElement("div", {
        "data-icon": "",
        className: dt(N == null ? void 0 : N.icon, (s = d == null ? void 0 : d.classNames) == null ? void 0 : s.icon)
    }, d.promise || d.type === "loading" && !d.icon ? d.icon || vg() : null, d.type !== "loading" ? d.icon || (j == null ? void 0 : j[Je]) || ow(Je) : null) : null, _.createElement("div", {
        "data-content": "",
    ...
    }, typeof d.description == "function" ? d.description() : d.description) : null), x.isValidElement(d.cancel) ? d.cancel : d.cancel && _i(d.cancel) ? _.createElement("button", {
        "data-button": !0,
        "data-cancel": !0,
        style: d.cancelButtonStyle || A,
        onClick: B => {
            var te, se;
            _i(d.cancel) && dr && ((se = (te = d.cancel).onClick) == null || se.call(te, B),
            en())
        }
        ,
        className: dt(N == null ? void 0 : N.cancelButton, (c = d == null ? void 0 : d.classNames) == null ? void 0 : c.cancelButton)
    }, d.cancel.label) : null, x.isValidElement(d.action) ? d.action : d.action && _i(d.action) ? _.createElement("button", {
        "data-button": !0,
        "data-action": !0,
        style: d.actionButtonStyle || z,
        onClick: B => {
            var te, se;
            _i(d.action) && ((se = (te = d.action).onClick) == null || se.call(te, B),
...
var Ow = x.forwardRef(function(e, t) {
    let {invert: n, position: r="bottom-right", hotkey: o=["altKey", "KeyT"], expand: i, closeButton: s, className: l, offset: a, mobileOffset: u, theme: c="light", richColors: f, duration: h, style: d, visibleToasts: w=xw, toastOptions: v, dir: y=zd(), gap: m=kw, loadingIcon: p, icons: g, containerAriaLabel: S="Notifications", pauseWhenPageIsHidden: C} = e
      , [k,P] = _.useState([])
      ...
      , W = _.useCallback(F => {
        P(K => {
            var X;
            return (X = K.find(he => he.id === F.id)) != null && X.delete || De.dismiss(F.id),
...
function Bw(e) {
    return x.isValidElement(e) && typeof e.type == "function" && "__radixId"in e.type && e.type.__radixId === Yh
}
function Uw(e, t) {
    const n = {
        ...t
...
var Kw = "DismissableLayer", $a = "dismissableLayer.update", Yw = "dismissableLayer.pointerDownOutside", Gw = "dismissableLayer.focusOutside", Ud, Xh = x.createContext({
    layers: new Set,
    ...
    x.useEffect( () => {
        if (c)
            return n && (u.layersWithOutsidePointerEventsDisabled.size === 0 && (Ud = h.body.style.pointerEvents,
            h.body.style.pointerEvents = "none"),
            u.layersWithOutsidePointerEventsDisabled.add(c)),
            u.layers.add(c),
            Vd(),
            () => {
                n && u.layersWithOutsidePointerEventsDisabled.size === 1 && (h.body.style.pointerEvents = Ud)
            }
    }
    , [c, h, n, u]),
    x.useEffect( () => () => {
    ...
    x.useEffect( () => {
        const P = () => d({});
        return document.addEventListener($a, P),
...
var Jw = Qu
  ...
  , Jh = x.forwardRef( (e, t) => {
    ...
    return s ? Rh.createPortal(E.jsx(We.div, {
        ...r,
        ref: t
    }), s) : null
}
...
var i1 = Tf[" useInsertionEffect ".trim().toString()] || _n;
function s1({prop: e, defaultProp: t, onChange: n= () => {}
, caller: r}) {
    const [o,i,s] = l1({
        defaultProp: t,
        onChange: n
...
var u1 = Object.freeze({
  ...
  , c1 = "VisuallyHidden"
  , Gs = x.forwardRef( (e, t) => E.jsx(We.span, {
    ...e,
    ref: t,
    style: {
        ...u1,
...
var nm = "ToastViewport"
  ...
  , rm = x.forwardRef( (e, t) => {
    const {__scopeToast: n, hotkey: r=m1, label: o="Notifications ({hotkey})", ...i} = e
      , s = Xs(nm, n)
      , l = f1(n)
      , a = x.useRef(null)
      , u = x.useRef(null)
...
var [x1,S1] = em(li, {
  ...
  , E1 = x.forwardRef( (e, t) => {
    ...
    x.useEffect( () => (L(),
    () => A()), [L, A]);
    const Q = x.useMemo( () => y ? fm(y) : null, [y]);
    return v.viewport ? E.jsxs(E.Fragment, {
        children: [Q && E.jsx(C1, {
            ...
            scope: n,
            onClose: z,
            children: si.createPortal(E.jsx(Gu.ItemSlot, {
                scope: n,
                children: E.jsx(Jw, {
                    asChild: !0,
                    ...
                    children: E.jsx(We.li, {
                        ...
                        onPointerMove: ve(e.onPointerMove, M => {
                            ...
                            Li(v1, f, X, {
                                discrete: !1
                            })) : Wd(K, v.swipeDirection, F) ? (S.current = K,
                            Li(g1, c, X, {
                                discrete: !1
                            }),
                        ...
                        onPointerUp: ve(e.onPointerUp, M => {
                            ...
                            G) {
                                ...
                                Wd(G, v.swipeDirection, v.swipeThreshold) ? Li(w1, d, b, {
                                    discrete: !0
                                }) : Li(y1, h, b, {
                                    discrete: !0
                                }),
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const L1 = x.forwardRef( ({color: e="currentColor", size: t=24, strokeWidth: n=2, absoluteStrokeWidth: r, className: o="", children: i, iconNode: s, ...l}, a) => x.createElement("svg", {
    ref: a,
    ...A1,
    width: t,
    height: t,
 ...
 */
const M1 = (e, t) => {
    const n = x.forwardRef( ({className: r, ...o}, i) => x.createElement(L1, {
        ref: i,
        iconNode: t,
        className: Sm(`lucide-${_1(e)}`, r),
        ...o
    }));
...
const hx = R1
  , bm = x.forwardRef( ({className: e, ...t}, n) => E.jsx(pm, {
    ref: n,
...
const mx = O1("group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full", {
    variants: {
        variant: {
  ...
  , Nm = x.forwardRef( ({className: e, variant: t, ...n}, r) => E.jsx(hm, {
    ref: r,
    className: lr(mx({
        variant: t
    }), e),
...
const gx = x.forwardRef( ({className: e, ...t}, n) => E.jsx(vm, {
    ref: n,
...
gx.displayName = vm.displayName;
const Rm = x.forwardRef( ({className: e, ...t}, n) => E.jsx(ym, {
    ref: n,
...
Rm.displayName = ym.displayName;
const Om = x.forwardRef( ({className: e, ...t}, n) => E.jsx(mm, {
    ref: n,
    className: lr("text-sm font-semibold", e),
    ...t
}));
Om.displayName = mm.displayName;
const _m = x.forwardRef( ({className: e, ...t}, n) => E.jsx(gm, {
    ref: n,
...
const Rx = async (e, t, n) => {
    ...
    for (let v = 0; v < l.length; v++) {
        const {name: y, fn: m} = l[v]
          , {x: p, y: g, data: S, reset: C} = await m({
            x: c,
            y: f,
            initialPlacement: r,
            placement: h,
...
const Ox = e => ({
    ...
    async fn(t) {
        ...
        const R = S / 2 - C / 2
          ...
          , M = P / 2 - v[w] / 2 + R
          , G = Ha(D, M, Q)
          , $ = !a.arrow && ro(o) != null && M !== G && i.reference[w] / 2 - (M < D ? A : z) - v[w] / 2 < 0
          , V = $ ? M < D ? M - D : M - Q : 0;
        return {
            [d]: h[d] + V,
            data: {
    ...
    return e === void 0 && (e = {}),
    {
        ...
        async fn(t) {
            ...
            const {placement: o, middlewareData: i, rects: s, initialPlacement: l, platform: a, elements: u} = t
              , {mainAxis: c=!0, crossAxis: f=!0, fallbackPlacements: h, fallbackStrategy: d="bestFit", fallbackAxisSideDirection: w="none", flipAlignment: v=!0, ...y} = Yt(e, t);
        ...
        async fn(t) {
            ...
            k && !h) {
                const A = Qe(c.left, 0)
                  ...
                  , D = Qe(c.top, 0)
                  , Q = Qe(c.bottom, 0);
                d ? R = w - 2 * (A !== 0 || z !== 0 ? A + z : Qe(c.left, c.right)) : P = v - 2 * (D !== 0 || Q !== 0 ? D + Q : Qe(c.top, c.bottom))
            }
            await a({
                ...t,
                availableWidth: R,
...
function ef(e) {
    return !qs() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof Ge(e).ShadowRoot
}
...
const Ux = ["transform", "translate", "scale", "rotate", "perspective"]
  , Vx = ["transform", "translate", "scale", "rotate", "perspective", "filter"]
  , Wx = ["paint", "layout", "strict", "content"];
function tc(e) {
    const t = nc()
      , n = Et(e) ? Ct(e) : e;
    return Ux.some(r => n[r] ? n[r] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || Vx.some(r => (n.willChange || "").includes(r)) || Wx.some(r => (n.contain || "").includes(r))
}
function Hx(e) {
    let t = Ln(e);
    for (; Mt(t) && !qr(t); ) {
...
function Ln(e) {
    if (oo(e) === "html")
        return e;
    const t = e.assignedSlot || e.parentNode || ef(e) && e.host || jt(e);
    return ef(t) ? t.host : t
}
function jm(e) {
    const t = Ln(e);
    return qr(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Mt(t) && ai(t) ? t : jm(t)
}
function Zo(e, t, n) {
    var r;
    t === void 0 && (t = []),
    ...
    if (i) {
        const l = Ka(s);
        return t.concat(s, s.visualViewport || [], ai(o) ? o : [], l && n ? Zo(l) : [])
    }
...
function Gx(e) {
    ...
    const c = Lt(0)
      , f = Mt(r);
    if ((f || !f && !i) && ((oo(r) !== "body" || ai(s)) && (a = Js(r)),
    Mt(r))) {
        const d = or(r);
        u = jr(r),
...
function zm(e, t) {
    const n = Ln(e);
    return n === t || !Et(n) || qr(n) ? !1 : Ct(n).position === "fixed" || zm(n, t)
}
function tS(e, t) {
    const n = t.get(e);
    if (n)
    ...
    for (; Et(s) && !qr(s); ) {
        ...
        (i ? !a && !o : !a && l.position === "static" && !!o && Jx.has(o.position) || ai(s) && !a && zm(e, s)) ? r = r.filter(c => c !== s) : o = l,
        s = Ln(s)
    }
    return t.set(e, r),
    r
...
function nS(e) {
    ...
    const s = [...n === "clippingAncestors" ? Zs(t) ? [] : tS(t, this._c) : [].concat(n), r]
      , l = s[0]
      , a = s.reduce( (u, c) => {
        const f = tf(t, c, o);
...
function aS(e, t) {
    ...
    function s(l, a) {
        ...
        function C(k) {
            ...
            P === 1 && !Bm(u, e.getBoundingClientRect()) && s(),
            S = !1
        }
        try {
    ...
    , [])
      ...
      , Q = x.useCallback( () => {
        ...
        gS(k.current, P.current, b).then(N => {
            ...
            M.current && !Ts(R.current, j) && (R.current = j,
            si.flushSync( () => {
                f(j)
            }
            ))
...
var ic = "PopperContent"
  ...
  , Xm = x.forwardRef( (e, t) => {
    ...
    const {__scopePopper: n, side: r="bottom", sideOffset: o=0, align: i="center", alignOffset: s=0, arrowPadding: l=0, avoidCollisions: a=!0, collisionBoundary: u=[], collisionPadding: c=0, sticky: f="partial", hideWhenDetached: h=!1, updatePositionStrategy: d="optimized", onPlaced: w, ...v} = e
      ...
      , {refs: M, floatingStyles: G, placement: $, isPositioned: V, middlewareData: b} = wS({
        strategy: "fixed",
        placement: L,
        whileElementsMounted: (...Jt) => uS(...Jt, {
        ...
        middleware: [SS({
            ...
            ...Q,
            apply: ({elements: Jt, rects: ui, availableWidth: nl, availableHeight: ci}) => {
...
var IS = Gm
  ...
  , [$S,tg] = el(eg)
  , ng = e => {
    const {__scopeTooltip: t, delayDuration: n=zS, skipDelayDuration: r=300, disableHoverableContent: o=!1, children: i} = e
      , s = x.useRef(!0)
      , l = x.useRef(!1)
      , a = x.useRef(0);
    return x.useEffect( () => {
...
var US = "TooltipPortal"
  ...
  , og = x.forwardRef( (e, t) => {
    ...
    return E.jsx(Ku, {
        present: r || s.open,
        children: s.disableHoverableContent ? E.jsx(ig, {
            side: o,
            ...i,
            ref: t
        }) : E.jsx(WS, {
  ...
  , ig = x.forwardRef( (e, t) => {
    const {__scopeTooltip: n, children: r, "aria-label": o, onEscapeKeyDown: i, onPointerDownOutside: s, ...l} = e
      ...
      , u = sc(n)
      , {onClose: c} = a;
    return x.useEffect( () => (document.addEventListener(sf, c),
    () => document.removeEventListener(sf, c)), [c]),
    x.useEffect( () => {
        if (a.trigger) {
            const f = h => {
                const d = h.target;
...
var sg = "TooltipArrow"
  , YS = x.forwardRef( (e, t) => {
    const {__scopeTooltip: n, ...r} = e
      , o = sc(n);
    return QS(sg, n).isInside ? null : E.jsx(FS, {
        ...o,
        ...r,
        ref: t
    })
...
var tE = ng
  , lg = og;
const nE = tE
  , rE = x.forwardRef( ({className: e, sideOffset: t=4, ...n}, r) => E.jsx(lg, {
    ref: r,
    sideOffset: t,
...
rE.displayName = lg.displayName;
const oE = "/assets/herbal-queen-pouch-tiEHeTXi.png"
  , ag = "/assets/herbal-queen-logo-NVMONKqR.png"
  , iE = () => E.jsxs("section", {
    className: "relative overflow-hidden bg-cream min-h-screen flex items-center",
    children: [E.jsx("div", {
        ...
        children: E.jsxs("svg", {
            ...
            fill: "none",
            children: [E.jsx("path", {
                d: "M200 100 Q250 200 200 300 Q150 400 200 500",
                stroke: "hsl(140,20%,50%)",
                strokeWidth: "2",
                fill: "none"
            }), E.jsx("path", {
                d: "M600 50 Q650 150 600 250 Q550 350 600 450",
                stroke: "hsl(140,20%,50%)",
                strokeWidth: "2",
                fill: "none"
            }), E.jsx("circle", {
        ...
        className: "container mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center relative z-10",
        children: [E.jsxs("div", {
            ...
            children: [E.jsx("img", {
                ...
                children: [E.jsx("span", {
                    className: "block text-7xl md:text-8xl lg:text-9xl font-black text-gradient-primary",
                    children: "HERBAL"
                }), E.jsx("span", {
                    className: "block text-7xl md:text-8xl lg:text-9xl font-black text-gradient-primary",
                    children: "QUEEN"
                ...
                className: "text-xl md:text-2xl text-muted-foreground font-medium max-w-md",
                children: "6 Sacred Ayurvedic Herbs for Women"
            }), E.jsx("div", {
                className: "flex flex-wrap gap-3",
                children: ["Anxiety & Stress", "Restful Sleep", "Weight Support", "Energy & Focus"].map(e => E.jsx("span", {
                    className: "bg-background border border-border rounded-full px-5 py-2.5 text-sm font-semibold text-foreground shadow-sm",
                    children: e
                }, e))
            }), E.jsxs("div", {
                className: "flex items-center gap-6 pt-4",
                children: [E.jsx("button", {
                    className: "bg-gradient-primary text-primary-foreground font-bold px-8 py-4 rounded-full text-lg shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all hover:scale-105",
                    children: "Shop Now"
                }), E.jsx("span", {
                    className: "text-muted-foreground font-medium",
                    children: "60 Capsules · Dietary Supplement"
                })]
            })]
        }), E.jsx("div", {
            ...
            children: E.jsxs("div", {
                ...
                children: [E.jsx("div", {
                    ...
                    src: oE,
                    alt: "HERBAL QUEEN Ayurvedic Supplement Stand-Up Pouch",
  ...
  , sE = "/assets/benefit-anxiety-BY9Io2oD.png"
  , lE = "/assets/benefit-sleep-BWc1EWwN.png"
  , aE = "/assets/benefit-weight-ClFbsjDb.png"
  , uE = "/assets/benefit-energy-DIBzeh57.png"
  , cE = [{
    img: sE,
    title: "Anxiety & Stress",
    desc: "Ashwagandha & Brahmi calm your nervous system naturally."
}, {
    img: lE,
    title: "Restful Sleep",
    desc: "Fall asleep faster and wake refreshed with adaptogenic herbs."
}, {
    img: aE,
    title: "Weight Support",
    desc: "Balanced metabolism through ancient Ayurvedic formulations."
}, {
    img: uE,
    title: "Energy & Focus",
    desc: "Sustained vitality without caffeine crashes or jitters."
}]
  , dE = () => E.jsx("section", {
    ...
    children: E.jsxs("div", {
        ...
        children: [E.jsxs("div", {
            ...
            children: cE.map( ({img: e, title: t, desc: n}, r) => E.jsxs("div", {
                className: "group bg-card border border-border rounded-2xl p-8 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 text-center",
                style: {
                    animationDelay: `${r * .1}s`
                },
                children: [E.jsx("div", {
                    className: "w-28 h-28 mx-auto mb-6 rounded-2xl bg-accent overflow-hidden flex items-center justify-center p-2 group-hover:scale-105 transition-transform",
                    children: E.jsx("img", {
                        src: e,
                        alt: t,
  ...
  , fE = "/assets/herb-ashwagandha-kPYUrGzE.png"
  , pE = "/assets/herb-shatavari-CK0r5gjV.png"
  , hE = "/assets/herb-brahmi-BHHf93w3.png"
  , mE = "/assets/herb-tulsi-ChVjSU9_.png"
  , gE = "/assets/herb-moringa-CERjveWw.png"
  , vE = "/assets/herb-turmeric-BlAee-7g.png"
  , yE = [{
    name: "Ashwagandha",
  ...
  , wE = () => E.jsx("section", {
    className: "py-24 bg-sage/30",
    children: E.jsxs("div", {
        className: "container mx-auto px-6",
        children: [E.jsxs("div", {
            className: "text-center mb-16 space-y-4",
            children: [E.jsx("span", {
                className: "text-sage-foreground font-bold text-sm tracking-widest uppercase",
                children: "Pure Ingredients"
            }), E.jsxs("h2", {
                className: "text-4xl md:text-5xl font-black text-foreground",
                children: ["6 Sacred ", E.jsx("span", {
                    className: "text-gradient-primary",
                    children: "Herbs"
                })]
            })]
            ...
            children: yE.map( ({name: e, benefit: t, img: n}) => E.jsxs("div", {
                className: "bg-background rounded-2xl p-6 text-center border border-border hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 group",
                children: [E.jsx("div", {
                    className: "w-24 h-24 mx-auto mb-4 rounded-full bg-accent/50 overflow-hidden flex items-center justify-center p-2 group-hover:scale-110 transition-transform",
                    children: E.jsx("img", {
                        src: n,
                        alt: e,
                        className: "w-full h-full object-contain"
  ...
  , xE = () => E.jsxs("section", {
    ...
    children: [E.jsxs("div", {
        ...
        children: [E.jsx("div", {
            ...
            className: "absolute bottom-10 right-20 w-60 h-60 border border-primary-foreground rounded-full"
        })]
    }), E.jsxs("div", {
        className: "container mx-auto px-6 text-center relative z-10 space-y-8",
        children: [E.jsxs("h2", {
            className: "text-4xl md:text-6xl font-black text-primary-foreground leading-tight",
            children: ["Your Wellness Journey", E.jsx("br", {}), "Starts Here"]
        }), E.jsx("p", {
            className: "text-primary-foreground/80 text-xl max-w-lg mx-auto",
            children: "Join thousands of women who trust HERBAL QUEEN for their daily Ayurvedic ritual."
        }), E.jsx("button", {
            className: "bg-background text-primary font-bold px-10 py-4 rounded-full text-lg shadow-2xl hover:scale-105 transition-transform",
            children: "Order Now — $34.99"
        }), E.jsx("p", {
            className: "text-primary-foreground/60 text-sm",
            children: "Free shipping · 30-day guarantee"
        })]
    })]
})
  , SE = () => E.jsx("footer", {
    ...
    children: E.jsxs("div", {
        ...
        children: [E.jsx("img", {
            ...
            className: "text-2xl font-black text-background tracking-tight",
            children: "HERBAL QUEEN"
        }), E.jsx("p", {
            className: "text-background/50 text-sm max-w-md mx-auto",
            ...
            className: "text-background/30 text-xs",
            children: "© 2026 Herbal Queen. All rights reserved."
        })]
    })
})
  , EE = () => E.jsxs("div", {
    className: "min-h-screen bg-background font-display",
    children: [E.jsx(iE, {}), E.jsx(dE, {}), E.jsx(wE, {}), E.jsx(xE, {}), E.jsx(SE, {})]
})
  , CE = () => {
    const e = Qh();
    return x.useEffect( () => {
  ...
  , PE = () => E.jsx(h0, {
    client: kE,
    children: E.jsxs(nE, {
        children: [E.jsx(vx, {}), E.jsx(_w, {}), E.jsx(J0, {
            children: E.jsxs(X0, {
                children: [E.jsx(Ia, {
                    path: "/",
                    element: E.jsx(EE, {})
...
Oh(document.getElementById("root")).render(E.jsx(PE, {}));
